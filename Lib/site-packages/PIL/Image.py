    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def paste(self, im, box=None, mask=None):
        ...
        if len(box) == 2:
            ...
            if isImageType(im):
                ...
                raise ValueError("cannot determine region size; use 4-node box")
    ...
    def remap_palette(self, dest_map, source_palette=None):
        ...
        :param dest_map: A list of indexes into the original palette.
           e.g. ``[1,0]`` would swap a two node palette, and ``list(range(256))``
...
class Exif(MutableMapping):
    ...
    def _fixup_dict(self, src_dict):
        # Helper function
        # returns a dict with any single node tuples/lists as individual values
