...
class Cache(object):
    ...
    def get(
        ...
        # type: (...) -> Link
        """Returns a link to a cached node if it exists, otherwise returns the
        passed link.
        """
        raise NotImplementedError()
...
class WheelCache(Cache):
    ...
    def get_cache_entry(
        ...
        """Returns a CacheEntry with a link to a cached node if it exists or
        None. The cache entry indicates if the node was found in the persistent
        or ephemeral cache.
        """
